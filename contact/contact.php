...
$sendToEmail = 'mark@markpriceproductions.com';
$sendToName = 'Mark';
...
try
{
    ...
    $emailTextHtml .= "<h3>New message from Mark Price Productions</h3><hr>";
    $emailTextHtml .= "<table>";
    ...
    $emailTextHtml .= "<p>Have a great day!<br><br>Sincerely,<br><br>Mark Price</p>";
